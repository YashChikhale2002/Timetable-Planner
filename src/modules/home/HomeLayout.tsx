    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
      ...
      <div className="hero bg-base-200 min-h-screen">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold">Create Your Perfect Resume in Minutes</h1>

            <p className="py-6">
              Craft your professional resume quickly and easily with our intuitive builder. Get
              noticed by employers today!
            </p>
      ...
      <div className="bg-resume-50 my-32">
        ...
        <footer className="footer footer-center bg-base-300 text-base-content p-4">
          <aside>
            <p>Copyright © {new Date().getFullYear()} - All right reserved by Resume BUilder</p>
          </aside>
        </footer>
      </div>
    </motion.div>
